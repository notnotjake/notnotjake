...
* Vectors: Developer project management tool (web, in progress)
* Spin: Apple Music companion app (iOS TestFlight)
...
Railway, SvelteKit, Bun, Tailwind, Resend & React Email, Evlog

### Tech I Like

Typescript, SwiftUI (kinda?), Hono, Drizzle, Sent.dm, Ghost CMS, Docker, Postgres
